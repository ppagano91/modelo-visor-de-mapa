 ...
 !function(t, e, i) {
    ...
    L.Draw.Polyline = L.Draw.Feature.extend({
        ...
        _endPoint: function(e, i, o) {
            if (this._mouseDownOrigin) {
                ...
                this._finishShape()) : n < 10 && L.Browser.touch ? this._finishShape() : Math.abs(a) < 9 * (t.devicePixelRatio || 1) && this.addVertex(o.latlng),
    ...
    L.Draw.Rectangle = L.Draw.SimpleShape.extend({
        ...
        _getTooltipText: function() {
            ...
            return a && (t = this._shape._defaultShape ? this._shape._defaultShape() : this._shape.getLatLngs(),
    ...
    function() {
        ...
        L.GeometryUtil = L.extend(L.GeometryUtil || {}, {
            ...
            readableArea: function(e, i, o) {
                ...
                return i ? (n = ["ha", "m"],
                this.type = typeof i,
                "string" === this.type ? n = [i] : "boolean" !== this.type && (n = i),
                a = e >= 1e6 && -1 !== n.indexOf("km") ? L.GeometryUtil.formattedNumber(1e-6 * e, o.km) + " km²" : e >= 1e4 && -1 !== n.indexOf("ha") ? L.GeometryUtil.formattedNumber(1e-4 * e, o.ha) + " ha" : L.GeometryUtil.formattedNumber(e, o.m) + " m²") : (e /= .836127,
    ...
    L.Polygon.include({
        intersects: function() {
            ...
            return !this._tooFewPointsForIntersection() && (!!L.Polyline.prototype.intersects.call(this) || (t = a.length,
            e = a[0],
            i = a[t - 1],
            o = t - 2,
    ...
    L.Control.Draw = L.Control.extend({
        ...
        onAdd: function(t) {
            ...
            for (var a in this._toolbars)
                this._toolbars.hasOwnProperty(a) && (e = this._toolbars[a].addToolbar(t)) && (o || (L.DomUtil.hasClass(e, "leaflet-draw-toolbar-top") || L.DomUtil.addClass(e.childNodes[0], "leaflet-draw-toolbar-top"),
                o = !0),
                i.appendChild(e));
            return i
        },
    ...
    L.Toolbar = L.Class.extend({
        ...
        _createActions: function(t) {
            ...
            for (var l = 0; l < r; l++)
                "enabled"in s[l] && !s[l].enabled || (e = L.DomUtil.create("li", "", n),
    ...
    L.EditToolbar.Edit = L.Handler.extend({
        ...
        _enableLayerEdit: function(t) {
            ...
            o.options.poly = i),
            this.options.selectedPathOptions && (e = L.Util.extend({}, this.options.selectedPathOptions),
            e.maintainColor && (e.color = o.options.color,
